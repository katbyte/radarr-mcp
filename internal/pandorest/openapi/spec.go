...
// is a `$ref` into components/responses (some documents do this for their error codes);
...
type Schema struct {
	...
	// Required names the properties an object must carry.
...
// is not a reference. A single-element allOf wrapping a $ref (how some documents
