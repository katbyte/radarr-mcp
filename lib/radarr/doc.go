...
// Package radarr is a typed client for Radarr 3.0.0, generated by internal/pandorest
// from the definitions in api-definitions/radarr, which were imported from docs/radarr-openapi.json.
//
// # Layout
//
...
//
//   - radarr-text-plain-twin
//   - radarr-undeclared-responses
//   - radarr-root-path-parameter
//   - radarr-command-body
//   - radarr-statuses
//   - radarr-undeclared-fields
//   - radarr-command-resource-body
//   - radarr-required-parameters
//   - radarr-write-responses
//   - radarr-bulk-responses
//   - radarr-host-required
//   - radarr-put-ids
package radarr
